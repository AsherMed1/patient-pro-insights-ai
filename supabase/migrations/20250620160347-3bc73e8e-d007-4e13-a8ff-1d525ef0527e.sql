...
-- Fix the verify_portal_session function to ensure immutable search_path
-- This addresses any remaining instances that may not have been updated

DROP FUNCTION IF EXISTS public.verify_portal_session(text, text);
