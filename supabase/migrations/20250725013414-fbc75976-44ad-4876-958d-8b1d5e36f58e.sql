-- First, drop the dependent policy and function
DROP POLICY IF EXISTS "User form submissions access" ON form_submissions;
...
-- Recreate the form submissions policy
CREATE POLICY "User form submissions access" 
