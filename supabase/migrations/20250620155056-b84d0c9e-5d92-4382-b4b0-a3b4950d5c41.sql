...
-- Fix the create_secure_portal_session function to have an immutable search_path
DROP FUNCTION IF EXISTS public.create_secure_portal_session(text, text, inet, text);
