...
export const updateBrendaMaddoxIntake = async () => {
  console.log('Updating Brenda Maddox appointment...');
  ...
  if (error) {
    console.error('Error updating Brenda Maddox appointment:', error);
    return { success: false, error };
  }
  
  console.log('✅ Successfully updated Brenda Maddox appointment:', data);
