  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white">
        ...
        <CardContent>
          <div className="stat-value !text-white">{stats.totalProjects}</div>
      ...
      <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white">
        ...
        <CardContent>
          <div className="stat-value !text-white">{stats.totalAppointments.toLocaleString()}</div>
      ...
      <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white">
        ...
        <CardContent>
          <div className="stat-value !text-white">{stats.totalAgents.toLocaleString()}</div>
