...
import { Save, Plus, Trash2, Palette, Building, Users, FileText } from 'lucide-react';
...
const ProjectBrandingEditor = ({ project, isOpen, onClose, onSave }: ProjectBrandingEditorProps) => {
  const [customizations, setCustomizations] = useState({
    custom_logo_url: project.custom_logo_url || '',
    brand_primary_color: project.brand_primary_color || '#3B82F6',
    brand_secondary_color: project.brand_secondary_color || '#8B5CF6',
    custom_insurance_list: project.custom_insurance_list || [],
    custom_doctors: project.custom_doctors || [],
    custom_facility_info: project.custom_facility_info || {}
  });
  ...
  useEffect(() => {
    ...
    setFacilityInfo({
      name: project.custom_facility_info?.name || '',
      address: project.custom_facility_info?.address || '',
      phone: project.custom_facility_info?.phone || '',
      description: project.custom_facility_info?.description || ''
    });
  }, [project]);
  ...
  const handleSave = async () => {
    try {
      ...
      toast({
        title: "Success",
        description: "Project branding saved successfully!",
      });
      ...
      toast({
        title: "Error",
        description: "Failed to save project branding",
        variant: "destructive",
      });
    } finally {
      setSaving(false);
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center space-x-2">
            ...
            <span>Project Branding: {project.project_name}</span>
          </DialogTitle>
          <DialogDescription>
            Customize branding, insurance providers, doctors, and facility information for all forms in this project.
          </DialogDescription>
        </DialogHeader>
