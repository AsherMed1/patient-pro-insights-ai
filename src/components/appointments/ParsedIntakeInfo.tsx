          ...
          {parsedPathologyInfo && parsingCompletedAt && (
            <Card className="bg-amber-50 border-amber-200">
              <CardContent className="pt-4 space-y-2">
                ...
                {/* Duration already rendered above at the top of Medical Information */}
                ...
                {formatValue(parsedPathologyInfo.treatment) && !String(parsedPathologyInfo.treatment).toLowerCase().match(/^blood\s*thinners?$/i) && (
                  <div className="text-sm">
