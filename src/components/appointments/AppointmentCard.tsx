...
const AppointmentCard = ({
  ...
  const handleCancelSubmit = async () => {
    ...
    try {
      ...
      // Push cancellation reason tags to GHL so workflows can branch on them
      await pushCancellationTags(appointment.id, cancelReason);

      // For "no reschedule" reasons, also enable DND to stop outreach
  ...
  return <>
      <div className={cn(
        ...
        <div className="space-y-2">
          ...
          {/* Contact Info - Email - Always show with "-" fallback */}
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
...
<TooltipProvider>
          ...
          <div className="space-y-1">
            ...
            {['Premier Vascular', 'ECCO Medical', 'Davis Vein & Vascular', 'Horizon Vascular Specialists', 'Prospero Vascular and Interventional', 'Vascular Institute of Michigan', 'Alliance Vascular'].includes(appointment.project_name) && !appointment.date_of_appointment && (
