...
<TooltipProvider>
          ...
          <div className="space-y-1">
            ...
            {['Premier Vascular', 'ECCO Medical', 'Davis Vein & Vascular', 'Horizon Vascular Specialists', 'Prospero Vascular and Interventional', 'Vascular Institute of Michigan'].includes(appointment.project_name) && !appointment.date_of_appointment && (
